...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO users (username,email,phone,password,gender,usertype,disaster) VALUES ('$username','$email','$phone','$password','$gender','$usertype','$disaster')";
...
<body>
    ...
    <div class="background">
            <form onsubmit="return validateForm()" class="registration" method="post"> <!--onsubmit="return validateForm()"-->
                ...
                <select name="disaster" id="disaster" class="seelect" required>
                    ...
                    <option value="Tribal Clashes">Tribal Clashes</option>
